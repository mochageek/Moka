...
ActiveRecord::Schema.define(version: 2023_12_07_130955) do
  ...
  create_table "coffee_tag_relations", force: :cascade do |t|
    ...
    t.index ["coffee_id"], name: "index_coffee_tag_relations_on_coffee_id"
    t.index ["tag_id"], name: "index_coffee_tag_relations_on_tag_id"
  end
  ...
  add_foreign_key "coffee_tag_relations", "coffees"
